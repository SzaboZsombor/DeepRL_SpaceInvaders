...
def train_agent(episodes=1000, max_steps=10000, weights_output_path="best_model.pth"):
    best_score = -np.inf
    scores = []
    for episode in range(episodes):
        ...
        if best_score < total_reward:
            ...
            agent.local_model.save_model_weights("best_model.pth")
...
def main():
    ...
    weights_output_path = "best_model.pth"

    scores = train_agent(weights_output_path="best_model.pth")
